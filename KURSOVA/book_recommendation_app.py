...
combo_genre = ttk.Combobox(frame_recommend, font=("Arial", 12), values=["Фантастика", "Історичний роман", "Роман", "Есеїстика", "Поезія", "Трилер", "Мемуари", "Комедія", "Драма", "Готичний роман", "Листи", "Історична повість"])  
